...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Existing shadcn/HSL tokens (do not remove — used across the app)
      ...
      boxShadow: {
        ...
        "book-hover":
          "0 8px 24px rgba(107,16,32,0.16), 0 16px 48px rgba(107,16,32,0.18)",
        toolbar:
          "0 -1px 0 rgba(107,16,32,0.08), 0 -4px 24px rgba(0,0,0,0.06)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
