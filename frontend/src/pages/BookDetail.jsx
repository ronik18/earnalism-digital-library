      ...
      <section id="preview-payment" className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-6 pb-20 sm:pb-28" data-testid="preview-payment-section">
        <div className="preview-payment-shell">
          <div className="preview-payment-shell__cover" aria-hidden="true">
            ...
            <p>
              This controlled launch includes the Dracula core reader only. Reading time is credited to your wallet after payment confirmation and is spent only while you read. Dracula audio is not available yet; it remains coming soon until source, rights, and QA pass. Study guide, visual edition, ads, email, and social campaigns are not live in this release.
            </p>
