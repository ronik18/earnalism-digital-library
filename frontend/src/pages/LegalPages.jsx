...
export function Terms() {
  return <LegalPage title="Terms of Use" canonicalPath="/terms" description="The terms that apply to the current Earnalism reading experience.">
    ...
    <section><h2 className="font-serif-display text-2xl text-burgundy">The service</h2><p className="mt-3">The library presents the titles and features that are marked available on the site. Availability can change when a title, source, or service requirement needs review. Paid Reading Passes and public audiobooks are not offered in this launch.</p></section>
...
export function Privacy() {
  return <LegalPage title="Privacy" canonicalPath="/privacy" description="How the current Earnalism website handles information used to operate the service.">
    ...
    <section><h2 className="font-serif-display text-2xl text-burgundy">Browser storage</h2><p className="mt-3">The site uses browser storage for sign-in, Reader preferences and position, and short-lived page or catalogue state. These functions help the requested service work. Optional launch analytics and advertising trackers are not enabled in the current website build. You can clear locally stored data using your browser, although doing so may sign you out or reset preferences.</p></section>
