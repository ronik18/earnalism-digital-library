...
export function Terms() {
  return <LegalPage title="Terms of Use" canonicalPath="/terms" description="The terms that apply to the current Earnalism reading experience.">
    <p>Earnalism is a digital library venture operated by REO ENTERPRISE. These terms apply to the current India launch of the Earnalism website and its enabled reading features.</p>
