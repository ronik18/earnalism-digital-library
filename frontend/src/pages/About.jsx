  ...
  return (
    <div data-testid="about-page">
      <section className="max-w-4xl mx-auto px-5 sm:px-8 lg:px-12 pt-20 sm:pt-32 pb-12 text-center">
        ...
        <h1 className="font-serif-display text-4xl sm:text-6xl text-burgundy tracking-tight leading-[1.05] text-balance">An independent bookstore, and a quiet promise to readers.</h1>
