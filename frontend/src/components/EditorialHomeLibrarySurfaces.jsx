...
// These are commissioned illustrative perspectives, not customer testimonials
// or photographs of named people. The provenance record lives with the internal
// launch evidence so public copy can remain truthful without surfacing it.
const ILLUSTRATIVE_READER_PERSPECTIVES = [
  {
    id: "kolkata",
    tone: "blush",
    place: "Kolkata, India",
    ...
    <div className="reference-home" data-testid="home-reference-surface">
      ...
      <section className="reference-reader-perspectives" aria-labelledby="reader-perspectives-title" data-testid="reader-perspectives-section">
        ...
        <div className="reference-reader-perspectives__grid">
          {ILLUSTRATIVE_READER_PERSPECTIVES.map((perspective) => (
