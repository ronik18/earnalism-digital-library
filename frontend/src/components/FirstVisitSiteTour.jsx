...
const TOUR_STEPS = [
  {
    ...
    body: "A calm digital reading room for Bengali and English classics, made for unhurried discovery.",
  },
  {
    key: "preview",
    icon: BookOpen,
  ...
  },
  {
    key: "covers",
    icon: Compass,
    targetSelectors: ['[data-testid="curated-shelf-collage"]'],
    eyebrow: "Curated paths",
    title: "A shelf for every mood",
    body: "Move between Bengali life, gothic shadows, human nature, adventure, and complete short masterpieces.",
  },
  {
    key: "shelves",
    icon: ArrowRight,
