...
const TOUR_STEPS = [
  {
    ...
    body: "A calm digital library for thoughtful discovery, beautiful reading, and the brand promise: Where Learning Becomes Earning.",
  },
  {
    key: "preview",
    icon: BookOpen,
    ...
    body: "Begin with the reading room first. Earnalism lets each book earn your attention before you decide to go deeper.",
  },
  {
    key: "covers",
    icon: Compass,
    targetSelectors: ['[data-testid="live-cover-showcase"]', '[data-testid="live-cover-showcase-loading"]'],
    eyebrow: "Live shelves",
    title: "Browse what is ready now",
    body: "The cover rail keeps discovery visual and quick, so a new reader can move from curiosity to a preview without friction.",
  },
  {
    key: "shelves",
    icon: ArrowRight,
    targetSelectors: ['[data-testid="categories-view-all"]', "#collection"],
    eyebrow: "Choose a path",
    title: "Move by shelf or mood",
    body: "Explore Bengali classics, literature, business, technology, history, young readers, and more from one focused library path.",
  },
];
