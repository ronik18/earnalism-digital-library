...
const TOUR_STEPS = [
  {
    ...
    body: "A calm digital reading room for Bengali and English classics, with every public claim tied to release evidence.",
  },
  {
    key: "preview",
    icon: BookOpen,
    ...
    body: "Explore Bengali reader-only classics, English classics, and any listening releases only when their gates are proven.",
  },
  {
    key: "covers",
    icon: Compass,
    targetSelectors: ['[data-testid="curated-action-cards"]', '[data-testid="home-live-dracula"]'],
    eyebrow: "Curated entry points",
    title: "Three calm actions",
    body: "Bengali classics, Dracula as an English classics tile, and approved audiobooks each have a distinct release-safe state.",
  },
  {
    key: "shelves",
    icon: ArrowRight,
    targetSelectors: ['[data-testid="bengali-gothic-pipeline-shelf"]', '[data-testid="pipeline-books"]'],
    eyebrow: "Release truth stays visible",
    title: "Audio never leaks early",
    body: "Reader-only books still feel complete; audiobook controls stay hidden until endpoint, sync, QA, and browser gates pass.",
  },
];
