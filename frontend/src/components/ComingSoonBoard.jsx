...
const ACTION_CARDS = [
  ...
  },
  {
    icon: Headphones,
      ...
      title: "Listening editions",
      body: "Listening remains unavailable while title-specific release decisions are completed.",
    cta: "",
    to: "",
