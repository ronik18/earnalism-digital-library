...
const LOCKED_PRODUCT_SENTENCE = "The three India pilot Reader editions are free in full. Audiobooks are unavailable for this launch.";
...
describe("auth and account customer-copy contract", () => {
  ...
  test("describes the bounded free India launch on each applicable customer surface", () => {
