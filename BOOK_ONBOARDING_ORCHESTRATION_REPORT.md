...
| TTS_MODEL_LICENSE_AND_SUITABILITY_REVIEW | HOLD_LICENSE_REVIEW | selected model `kokoro` is not eligible for real internal generation: HOLD_LICENSE_REVIEW.; voice_license is missing or requires review.; commercial_use_status is missing or requires review. |
