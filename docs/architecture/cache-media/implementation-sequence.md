...
| A7 frontend | frontend after PR #344 | lifecycle/browser tests | PR #344 integrated | complete: route-owned request cancellation proven and corrected; no A8 started |
