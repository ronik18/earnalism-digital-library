...
ASSET_SPECS = [
    ...
    AssetSpec("facebook-cover.svg", "BEGIN WITH DRACULA", "Read the first 3 pages free. Listening requires an active Reading Pass.", 1640, 624, "Facebook cover", "Facebook"),
    ...
    AssetSpec("first-post-dracula.svg", "BEGIN WITH DRACULA", "Read the first 3 pages free", 1080, 1080, "first post square", "Instagram"),
