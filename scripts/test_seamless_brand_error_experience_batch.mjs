...
test("static SEO contract accurately records an intentional public-release hold", () => assert.deepEqual(JSON.parse(fs.readFileSync(path.join(root, "frontend/static-seo/controlled-publication-public.json"), "utf8")).publications, []));
