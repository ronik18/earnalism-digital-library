...
def main():
    ...
    require(library_path == "docs/design-system/pr371-library-interaction-baseline.json" and Path(library_path).exists(), "Library baseline record is missing", failures)
    require(library.get("expected_surface_sha256") == "0fc10999d742f8c36ee8e0febdfb6715d3526843e90b96c5918fe9408eaf0d07", "Library baseline expected fingerprint is not the authorized PR371 value", failures)
