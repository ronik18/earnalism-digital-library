...
def main():
    ...
    require(library_path == "docs/design-system/pr372-library-interaction-baseline.json" and Path(library_path).exists(), "Library baseline record is missing", failures)
    require(library.get("expected_surface_sha256") == "750e6eb58ebc1e6c55df6f6ba305dae460a2f39bbb4dda5661c08f59a6fd2a34", "Library baseline expected fingerprint is not the authorized PR372 value", failures)
