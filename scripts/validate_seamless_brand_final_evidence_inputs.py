...
def main():
    ...
    require(library_path == "docs/design-system/pr360-library-interaction-baseline.json" and Path(library_path).exists(), "Library baseline record is missing", failures)
