...
const books = [
  ...
  { slug: "a-white-heron", title: "A White Heron", author: "Sarah Orne Jewett", short_description: "English short story", language: "en", publication_status: "LIVE_APPROVED", reader_enabled: true, public_route: "/book/a-white-heron", reader_url: "/reader/a-white-heron", preview_enabled: true, preview_url: "/reader/a-white-heron", chapters: [{ id: "chapter-001", is_preview: true }] },
  { slug: "the-gift-of-the-magi", title: "The Gift of the Magi", author: "O. Henry", short_description: "English short story", language: "en", publication_status: "LIVE_APPROVED", reader_enabled: true, public_route: "/book/the-gift-of-the-magi", reader_url: "/reader/the-gift-of-the-magi", preview_enabled: true, preview_url: "/reader/the-gift-of-the-magi", chapters: [{ id: "chapter-001", is_preview: true }] },
  { slug: "the-canterville-ghost", title: "The Canterville Ghost", author: "Oscar Wilde", short_description: "English story", language: "en", publication_status: "LIVE_APPROVED", reader_enabled: true, public_route: "/book/the-canterville-ghost", reader_url: "/reader/the-canterville-ghost", preview_enabled: true, preview_url: "/reader/the-canterville-ghost", chapters: [{ id: "chapter-001", is_preview: true }] },
