...
const exactRoutes = new Set(["/", "/library", "/journal", "/about", "/about-legacy", "/contact", "/privacy", "/terms", "/copyright", "/pricing", "/micro-story", "/login", "/signup", "/signin", "/account", "/my-library", "/publishing", "/admin", "/admin/login", "/admin/launch-monitor"]);
