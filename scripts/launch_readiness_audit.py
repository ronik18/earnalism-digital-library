...
def analytics_event_schema() -> dict[str, Any]:
    event_metadata: dict[str, list[str]] = {
        ...
        "pricing_pack_view": ["pack_id", "label", "minutes", "price_inr", "selected", "source"],
        "pricing_pack_cta_click": ["pack_id", "price_inr", "coupon", "source"],
        "reading_time_explainer_view": ["book_slug", "source"],
...
def validate_mock_analytics_events(schema: dict[str, Any]) -> dict[str, Any]:
    ...
    mock_payloads = [
        ...
        {"event": "pricing_pack_view", "metadata": {"pack_id": "1h", "label": "The Quiet Hour", "minutes": 60, "price_inr": 89, "selected": True, "source": "pricing"}},
        {"event": "pricing_pack_cta_click", "metadata": {"pack_id": "1h", "price_inr": 89, "coupon": "", "source": "pricing"}},
        {"event": "reading_time_explainer_view", "metadata": {"book_slug": "dracula", "source": "pricing"}},
