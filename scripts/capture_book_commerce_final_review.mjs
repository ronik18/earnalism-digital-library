...
async function capture(state, context) {
  ...
  const response = await page.goto(`${baseUrl}${state.route}`, { waitUntil: "domcontentloaded", timeout: 90000 }); await settle(page); await maybeTab(page, state.action); await page.waitForTimeout(250);
