...
required=['capture-results.json','all-browser-capture-results.json','book-interaction-results.json','fixture-offer-results.json','commerce-geometry-results.json','heading-results.json','book-content-capability-results.json','live-offer-results.json','book-commerce-browser-results.json','browser-font-results.json','capture-stability-results.json','webkit-network-diagnostics.json']
...
summary={'head':head,'book_interaction':json.loads((current/'book-interaction-results.json').read_text()),'book_heights':heights,'commerce':json.loads((current/'commerce-geometry-results.json').read_text()),'headings':json.loads((current/'heading-results.json').read_text()),'browser_matrix':json.loads((current/'book-commerce-browser-results.json').read_text()),'browser_fonts':json.loads((current/'browser-font-results.json').read_text()),'capture_stability':json.loads((current/'capture-stability-results.json').read_text()),'webkit_network_diagnostics':json.loads((current/'webkit-network-diagnostics.json').read_text())}
