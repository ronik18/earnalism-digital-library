...
const AUDIO_B2_THRESHOLD_BYTES = Number.parseInt(
  process.env.AUDIO_B2_THRESHOLD_BYTES || `${100 * 1024 * 1024}`,
  10,
);
...
const B2_S3_MAX_ATTEMPTS = Number.parseInt(process.env.B2_S3_MAX_ATTEMPTS || "5", 10);
const ASSET_CONFIG = {
...
function b2Client() {
  ...
  return new S3Client({
    ...
    forcePathStyle: true,
    maxAttempts: B2_S3_MAX_ATTEMPTS,
    credentials: {
      accessKeyId,
      secretAccessKey,
    },
