...
Status: active
Policy version: platform_audiobook_acceptance_v4_89
...
- representative or full-book overall listening score `>= 8.9`
- every listening dimension, including anti-robotic and anti-choppy, `>= 8.9`
- confidence `>= 0.90`
- no fatal red flags:
