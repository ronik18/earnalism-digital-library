...
## 2026-07-21 The Call of the Wild Targeted Recovery and Listening Screen

- One single-use, lexical-preserving three-passage resynthesis at speed `0.94` resolved the original `metal/medal`, `feigned a/feign`, `coated/coded`, and missing-conjunction failures. Opening and closing reached exact ASR/source `10.0/1.0`; the retained Spitz passage remained exact.
- Thornton reached `9.9531/0.9953` only because all decoder arms wrote the correctly source-generated two-syllable word `petted` as the non-word `Pettid`. A separate offline projection bound one occurrence to the source word's pinned fallback-free G2P phonemes, made no new decoder or synthesis call, and produced exact `10.0/1.0` for all four representative passages without deleting speech or normalizing a substantive word.
- Independent four-sample listening QA passed the active English `PREMIUM_AUDIO_APPROVED` screen: overall scores `9.5`, `9.4`, `9.5`, `9.5`, minimum confidence `0.95`, every quality dimension at least its threshold, and no fatal flags. The stricter aspirational exact-10 comparison did not pass.
- A representative premium pass is not public release evidence. Full-title generation, full-title boundary/content ASR, measured sync, six-sample full-title listening, editorial review, delivery/upload, endpoint, browser, and publication gates remain unrun; public audio remains hidden.
- Local synthesis and ASR cost `$0.00`; the serialized listening screen was capped at `$0.20` with actual provider billing unreported. `paid_tts.lock` was restored byte-for-byte to SHA-256 `f586acc793022f28adb3e5fe08969075c2a16f09ef6814ebb31f6e6c90163df3`.

## 2026-07-21 The Call of the Wild Full-Title Objective Closure

- The single authorized `am_michael` full-title fingerprint generated 280/280 losslessly partitioned private WAVs and a 11,462.35-second recomposed master with SHA-256 `2d630a6e8d85ec241c75f9c78511acb2bda55dc225f901b7bdd2d93cfdbabe59`; local Kokoro and Whisper provider cost was `$0.00`.
- The representative pass did not generalize to the complete manuscript. Only 64/280 sections passed. Full-title aggregate ASR/source was `9.7347`, coverage `0.9738`, and precision `0.9731`; measured sync was `4.2553` with coverage `0.386` and failed.
