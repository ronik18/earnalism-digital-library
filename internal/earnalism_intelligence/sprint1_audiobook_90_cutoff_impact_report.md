...
| 4 | `nishkriti` — নিষ্কৃতি | Best complete representative set minimum L `8.0`, confidence `0.85` | Below listening/confidence; robotic/list-reading fatal flags | Uneven, robotic, list-like narration |
...
| 9 | `devdas` — দেবদাস / Devdas | Representative set minimum L `7.8`, confidence `0.85` | Listening failure and no complete release package | Conspicuously poor punctuation-heavy narration |
| 10 | `book-edfcf810c5` — ক্ষুধিত পাষাণ | One passage R-L `9.5` but R-ASR `7.5`; retained F-ASR `7.0362` | Objective source mismatch, provenance, sync, and delivery | Natural-sounding but incorrect or incomplete Bengali |
