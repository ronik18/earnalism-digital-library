...
Generated: `2026-07-13T05:53:00Z`
...
- Public reader: `Yes`
- Public audiobook: `No`
- Quality evidence: Studio-C `8.4, 8.4, 9.4, 8.3`; Chirp3-HD-Achird `9.4, 9.4, 8.4, 9.4`; minimum confidence `0.90`; no fatal flags
- Estimated spend: `$0.4686`; actual billing not reported
...
- Evidence: `internal/audiobook_lab/sprint1_publication/title_runs/the-last-leaf_release_gate_evidence.json`
