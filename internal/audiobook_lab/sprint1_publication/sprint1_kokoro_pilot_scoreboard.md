...
Generated: `2026-07-20T04:29:45Z`
...
| --- | --- | --- | --- | --- | --- |
| The Gift of the Magi | `af_bella`, then `bf_emma` | af_bella representative `10.0/1.0` all four, full title aggregate `9.9545/0.9952` but 8 sections failed; bf_emma `10.0/1.0, 9.6552/0.9655, 10.0/1.0, 9.8776/0.9758` | af_bella `9.6, 9.6, 9.5, 9.5`; bf_emma not run | `9.5 / 9.2` for af_bella representative | Both local voice lanes closed on objective failures; audio hidden |
...
| The Masque of the Red Death | `bf_emma` | `9.7959/0.9796, 10.0/1.0, 9.902/0.9902, 9.8824/0.9882` | not run | n/a | Fail; exact source integrity passed only 1/4 after bounded repair |
| The Tell-Tale Heart | `bf_emma` | `10.0/1.0, 10.0/1.0, 10.0/1.0, 9.8605/1.0` | not run | n/a | Fail; 3/4 exact, but both finale decoders retained unexpected trailing speech |
