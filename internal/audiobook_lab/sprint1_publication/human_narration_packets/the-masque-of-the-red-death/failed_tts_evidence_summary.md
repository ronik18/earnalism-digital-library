# Failed Provider Attempt Summary: The Masque of the Red Death

- Release classification: `INCOMPLETE_FAIL_CLOSED`
- Quality summary: `NOT_RUN`
- Exact blocker: `TITLE_AUDIO_RELEASE_GATES_INCOMPLETE; PAID_RUNTIME_ENV_GATES_MISSING`
- Failed structured attempts found: `0`

- No structured failed provider attempt was found in the local title evidence.
