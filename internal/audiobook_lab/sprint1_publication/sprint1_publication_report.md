...
- Provider calls: `6` bounded listening-QA judgments; no TTS or ASR calls
- Estimated spend: `$0.30`; actual provider billing was not reported
- Authorized budget remaining after estimate: `$174.70`
...
| `a-ghost-story` | A Ghost Story | English | Yes | No | ASR/source 9.7882 PASS; first/last PASS; listening QA minimum 8.3, confidence 0.90, no fatal flags; FAIL | `internal/audiobook_lab/sprint1_publication/title_runs/a-ghost-story_release_gate_evidence.json` | $0.30 estimated; actual not reported | AUDIO_HIDDEN_LISTENING_QA_REPAIR_REQUIRED |
...
| `the-open-window` | The Open Window | English | Yes | No | NOT_RUN | `internal/audiobook_lab/release_gate/the-open-window_20260705T161042Z/goliveevidence.json` | $0.0000 | SPRINT_TARGET_INCOMPLETE |
