...
class NarrationImportPacketTests(unittest.TestCase):
    ...
    def test_bengali_packet_is_sanitized_source_bound_and_deterministic(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(metadata["release_requirements"]["anti_robotic_texture_score_min"], 8.9)
            self.assertEqual(metadata["release_requirements"]["anti_choppy_join_score_min"], 8.9)
