...
def _rights_book(public_book: dict[str, Any], source: dict[str, Any]) -> dict[str, Any]:
    rights = {
        ...
        "translator_name": source.get("translator_name", ""),
        "translator_death_year": source.get("translator_death_year"),
        "illustrator_name": source.get("illustrator_name", ""),
        "illustrator_death_year": source.get("illustrator_death_year"),
        "editor_name": source.get("editor_name", ""),
        "edition_publication_year": source.get("edition_publication_year"),
